                            ...
                            <div class="col-lg-4 col-md-6 mb-4 pb-2">
                                <div class="blog-item">
                                    ...
                                    <div class="bg-white p-4">
                                        ...
                                        <a class="title" href="?p=detail&keyword=<?= urlencode($data->name) ?>"><?= $data->name ?></a>
                                        ...
                                        <div class="actions">
                                            <a class="btn btn-primary" href="?p=detail&keyword=<?= urlencode($data->name) ?>" role="button">Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="pagination">
    <nav>
        <ul class="pagination justify-content-center">
            <?php if ($page > 1): ?>
                <li class="page-item">
                    <a class="page-link" href="?p=find&page=<?= $page - 1 ?>&keyword=<?= urlencode($keyword) ?>" aria-label="Previous">
            ...
            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                    <a class="page-link" href="?p=find&page=<?= $i ?>&keyword=<?= urlencode($keyword) ?>"><?= $i ?></a>
                </li>
            <?php endfor; ?>

            <?php if ($page < $totalPages): ?>
                <li class="page-item">
                    <a class="page-link" href="?p=find&page=<?= $page + 1 ?>&keyword=<?= urlencode($keyword) ?>" aria-label="Next">
